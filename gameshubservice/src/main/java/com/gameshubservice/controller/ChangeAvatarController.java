...
public class ChangeAvatarController extends NavigationController {
    ...
    public void initialize() {
        ...
        exitButton.setOnAction(_ -> handleExit(changeAvatarStage));
        cancelButton.setOnAction(_ -> handleExit(changeAvatarStage));
        confirmButton.setOnAction(_ -> updateAvatar(selectedAvatarImageURL));
        ...
        for (Circle circle : avatarCircles) {
            circle.setOnMouseClicked(_ -> selectAvatarImage(circle, avatarCircles));
        }
    ...
    public void loadAvatarImages(Circle[] avatarCircles) {
        ...
        String avatarsFolderPath = "gameshubservice/images/avatars/";
    ...
    private void setSelectedAvatarImage(String avatarImageURL, Circle[] avatarCircles) {
        for (int i = 0; i < avatarCircles.length; i++) {
            ...
            if (fillPattern != null) {
                ...
                circleImagePath = circleImagePath.substring(circleImagePath.indexOf("gameshubservice"));
    ...
    private void selectAvatarImage(Circle circleToSelect, Circle[] avatarCircles) {
        ...
        if (pattern != null) {
            ...
            selectedAvatarImageURL = fullImageURL.substring(fullImageURL.indexOf("gameshubservice/"));
