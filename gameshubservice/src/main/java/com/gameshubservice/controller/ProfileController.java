...
public class ProfileController extends NavigationController {
    ...
    public void initialize() {
        ...
        changeUsernameButton.setOnAction(_ -> openChangeUsernameDialog());
        changePasswordButton.setOnAction(_ -> openChangePasswordDialog());
    ...
    private void openChangeUsernameDialog() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/gameshubservice/changeusername.fxml"));
    ...
    private void openChangePasswordDialog() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/gameshubservice/changepassword.fxml"));
        Parent root = loader.load();
