...
public class JSONProfileStore {
    //private static final String FILE_PATH = "gameshubservice/src/main/java/com/gameshubservice/data/profiles.json";
    private static final String FILE_PATH = "shared-data/profiles.json";
